...
The response2info sub consolidates code that would have been repeated by both methods, this is view code but for convenience it went here. What we're doing with this method is a raw dump of everything returned by WebService::Solr. 
...
Try some queries: http://localhost:3000/thin/select/text/ipod  http://localhost:3000/thin/select/features/cache http://localhost:3000/thin/select/manu/maxtor
