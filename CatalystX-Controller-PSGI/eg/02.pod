...
In this part I'll be covering converting parts of that legacy app into Catalyst
...
been over written. So we can tidy it up, and separate out the not found action
...
cleaning and add a Catalyst 404 handler, aka the default action
